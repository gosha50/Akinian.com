...
<body>	
	...
	<div id="main" class="contact" style="background-image: url(data:image/jpeg;base64,<?php echo $page->file($page->hero_image())->base64() ?>)">
		...
		<div class="intro">
			...
			<p>Web Apps Developer. Need a website as cool as this one?  Email me: <a href="mailto:hello@akinian.com">hello@akinian.com</a>, or call <a href="tel:1-360-609-9987">1-360-609-9987.</a>  </p>
		</div>
